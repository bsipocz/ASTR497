...
rand_coords = SkyCoord(np.random.uniform(1, 360, 1000)*u.deg, np.random.uniform(-1, 1, 1000)*u.deg, frame='galactic')
rand_coords.transform_to(FK5())
rand_FK5 = rand_coords.transform_to(FK5())
print(type(rand_FK5))
first_coord = rand_FK5.ra
second_coord = rand_FK5.dec
plt.plot(first_coord, second_coord, 'o', markersize = 1)
plt.show()
